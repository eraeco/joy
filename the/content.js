...
//sr.polyfill = {getURL: function(){ return 'http://localhost:8764/' } }; // for debugging  **THIS MUST HAVE // in front it during PRs
sr.polyfill = {getURL: function(){ return '/' } }; // for debugging  **THIS MUST HAVE // in front it during PRs
}());
